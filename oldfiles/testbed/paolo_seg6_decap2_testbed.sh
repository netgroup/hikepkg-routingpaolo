...
ECLAT_SCRIPT=components/routingpaolo/eclat_scripts/paolo_seg6_decap2.eclat
...
CLT_COMMAND="tcpdump -exxxvvv -i veth0 host fcf0:0:1:2::3"
CLT_EXEC=YES
...
SUT_COMMAND="ping cafe::2 -c 2 && ip -6 r add fcf0:0:1:2::3/32 via cafe::2 dev cl0 && ip -6 route add 2001:db8::/32 via cafe::2 dev cl0"
SUT_EXEC=YES
